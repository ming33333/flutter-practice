...
class MagicForest extends StatefulWidget {
  const MagicForest({super.key});

  @override
  State<MagicForest> createState() => _MagicForestState();
}

class _MagicForestState extends State<MagicForest> {
  bool isSwitch = false;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            Image.asset('images/MagicForest.webp'),
            const SizedBox(
              height: 10,
            ),
            const Divider(
