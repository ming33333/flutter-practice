...
class MagicVillage extends StatefulWidget {
  const MagicVillage({super.key});

  @override
  State<MagicVillage> createState() => _MagicVillageState();
}

class _MagicVillageState extends State<MagicVillage> {
  bool isSwitch = false;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            Image.asset('images/MagicalVillage.webp'),
            const SizedBox(
              height: 10,
            ),
            const Divider(
